...
# spring_a_temp, summer_a_temp, fall_a_temp, winter_a_temp
...
myt_sub <- unique(PerCov_anom[PerCov_anom$Taxa == "Mytilus",c(2,11)])
myt_sub$Year <- as.factor(myt_sub$Year)
#range(myt_sub$Year_Anom_Scale)
...
#
fuc_sub <- unique(PerCov_anom[PerCov_anom$Taxa == "FUCUS_TOTAL",c(2,11)])
...
spr <- ggplot(data=spring_a_temp, aes(x=Year, y=Num_Day_Less_0)) +
       geom_point(size=2) + theme_bw() + ylab("# of days air temp < 0 C") +
...
sum <- ggplot(data=summer_a_temp, aes(x=Year, y=Num_Day_More_15)) +
       geom_point(size=2) + theme_bw() + ylab("# of days air temp < 15 C") +
...
fal <- ggplot(data=fall_a_temp, aes(x=Year, y=Num_Day_Less_0)) +
       geom_point(size=2) + theme_bw() + ylab("# of days air temp < 0 C") +
...
win <- ggplot(data=winter_a_temp, aes(x=Year, y=Num_Day_Less_neg10)) +
       geom_point(size=2) + theme_bw() + ylab("# of days air temp < -10 C") +
